<?php
    ...
    $sql = "UPDATE db_nhanvien SET hovaten='$hoTen', chucvu='$chucVu', sdt_coquan = '$soMayBan', sdt_didong = '$soDiDong', email='$email', ma_donvi = '$maDonVi' WHERE ma_nhanvien = '$maNhanVien'";
    // echo $sql;
